...
def attachment_result(answers):
    ...
    if (
        ...
        advice = (
            ...
            "эмоций и учись прямо говорить о своих "
        ...
        description = (
            ...
            "становится холоднее или отвечает реже, "
            "ты можешь быстро начать переживать "
            "и искать объяснение."
        )

        advice = (
            "Не оценивай отношения по каждому сообщению "
            "и не ищи постоянного подтверждения чувств "
            "партнёра."
        )
        ...
        description = (
            ...
            "пространство. Когда отношения становятся "
            "слишком интенсивными, может появляться "
            "желание дистанцироваться."
        )

        advice = (
            "Полезно учиться оставаться в контакте "
            "даже тогда, когда близость вызывает "
            "дискомфорт."
        )
