...
# Он НЕ является оригинальным ECR-RS.
#
# Основа модели:
...
ATTACHMENT_QUESTIONS = [
    ...
    (
        ...
        "Что тебе обычно ближе?\n\n"
        "1. Спокойно занимаюсь своими делами.\n"
        "2. Замечаю это, но особо не переживаю.\n"
        "3. Иногда начинаю думать, почему он не отвечает.\n"
        "4. Начинаю искать причину и переживать.\n"
        "5. Мне становится трудно перестать думать об этом."
    ),

    (
        "avoidance",
        "Человек, который тебе нравится, хочет проводить с тобой "
        "намного больше времени. Твоя реакция?\n\n"
    ...
    (
        "anxiety",
        "Партнёр стал немного холоднее обычного. Что происходит чаще всего?\n\n"
        "1. Я спокойно жду и смотрю на общую ситуацию.\n"
        "2. Немного замечаю изменение.\n"
        "3. Начинаю думать, что причина во мне.\n"
        "4. Сильно анализирую его поведение.\n"
        "5. Мне нужно быстро понять, не изменились ли его чувства."
    ),
    ...
    (
        ...
        "3. Зависит от ситуации.\n"
        "4. Избегать разговора какое-то время.\n"
        "5. Закрыться и решать всё самостоятельно."
    ),

    (
        "anxiety",
        "Партнёр проводит вечер отдельно с друзьями. Что тебе ближе?\n\n"
        "1. Нормально, у каждого своя жизнь.\n"
        "2. Я почти не обращаю на это внимания.\n"
        "3. Иногда мне хочется знать, как проходит вечер.\n"
    ...
    (
        ...
        "5. Мне очень трудно позволить другому человеку увидеть "
        "мою уязвимость."
    ),
    ...
    (
        ...
        "4. Я захочу быстрее получить подтверждение, что всё нормально.\n"
        "5. До разговора мне будет очень трудно успокоиться."
    ),

    (
        "avoidance",
        "Партнёр хочет поговорить о ваших чувствах. Что ближе?\n\n"
    ...
    (
        "anxiety",
        "Если человек, который тебе важен, сказал, что ему нужно "
        "немного пространства, твоя первая реакция чаще:\n\n"
        "1. Я спокойно это принимаю.\n"
        "2. Немного удивляюсь, но принимаю.\n"
        "3. Начинаю думать, что это может значить.\n"
    ...
    (
        ...
        "Что тебе ближе?\n\n"
        "1. Это вызывает чувство близости и спокойствия.\n"
...
def attachment_result(answers):
    ...
    if (
        ...
        description = (
            ...
            "скорее не вызывают сильной тревоги или "
            "желания постоянно держать дистанцию."
        )
        ...
        recommendation = (
            ...
            "словами, а не исчезновением или эмоциональным закрытием."
        )
        ...
        description = (
            ...
            "в отношениях и стремление защищать себя дистанцией. "
            "Поэтому близость может одновременно притягивать "
            "и вызывать напряжение."
        )

        recommendation = (
            "Не принимай решения об отношениях на эмоциональном пике. "
            "Сначала разберись, чего ты хочешь, затем открыто скажи "
            "об этом человеку."
        )
    ...
    result = (
        ...
        "а не диагностический инструмент. "
        "Проценты — наглядный перевод ответов в шкалу 0–100, "
        "а не клинические нормативы."
    )
...
async def handle_attachment_test(
    ...
    values = {
        "1️⃣ Первый вариант": 1,
        "2️⃣ Второй вариант": 2,
        "3️⃣ Третий вариант": 3,
        "4️⃣ Четвёртый вариант": 4,
        "5️⃣ Пятый вариант": 5,
    }
